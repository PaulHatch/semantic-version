...
const createTestRepo = (
  ...
  repoDefaultConfig?: Partial<ActionConfig>,
) => {
  ...
  return {
    ...
    makeCommit: (msg: string, path: string = "") => {
      if (windows) {
        run(
          `fsutil file createnew ${path !== "" ? path.trim() + "/" : ""}test${i++} 0`,
        );
      } else {
    ...
    runAction: async (inputs?: Partial<ActionConfig>) => {
      ...
      return await testRunner.runSemanticVersion(config, repoDirectory);
    },
    exec: run,
  };
};
...
// Run tests for both interfaces
const testInterfaces: TestInterface[] = ["action", "cli"];

testInterfaces.forEach((testInterface) => {
  describe(`Semantic Version Tests (${testInterface})`, () => {
    const testRunner = createTestRunner(testInterface);
    ...
    test(
      ...
      async () => {
        const repo = createTestRepo(testRunner, { tagPrefix: "" }); // 0.0.0
    ...
    test(
      ...
      async () => {
        ...
        const result = await repo.runAction();
        const subprojectResult = await repo.runAction({
    ...
    test(
      "Version Namespace is tracked separately",
      async () => {
        const repo = createTestRepo(testRunner, { tagPrefix: "" }); // 0.0.0
    ...
    test(
      ...
      async () => {
        const repo = createTestRepo(testRunner, { tagPrefix: "" }); // 0.0.1
    ...
    test(
      ...
      async () => {
        const repo = createTestRepo(testRunner, { tagPrefix: "version/" }); // 0.0.0
    ...
    test(
      ...
      async () => {
        const repo = createTestRepo(testRunner, { tagPrefix: "v" }); // 0.0.0
    ...
    test(
      ...
      async () => {
        const repo = createTestRepo(testRunner, { namespace: "test" });
    ...
    test(
      ...
      async () => {
        const repo = createTestRepo(testRunner, { tagPrefix: "" });
    ...
    test(
      "Patch increments each time when bump each commit is set",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}",
    ...
    test(
      "Patch does not increment on bump each commit if a patch pattern is set",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}+${increment}",
    ...
    test(
      "Patch pattern increment is correct on empty repo",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}+${increment}",
    ...
    test(
      "Patch pattern increment is correct/matches non-bumped on empty repo",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}+${increment}",
    ...
    test(
      "Patch pattern applied when present using tag as initial version",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}+${increment}",
    ...
    test(
      "Pre-release mode does not update major version if major version is 0",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}",
    ...
    test(
      "Pre-release mode updates major version if major version is not 0",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}",
    ...
    test(
      "Tagged commit is flagged as release",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "v",
    ...
    test(
      "Pre-release mode with bump each commit does not update major version if major version is 0",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}",
    ...
    test(
      "Pre-release mode with bump each commit does not update major version if major version is 0, respecting patch pattern",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "",
          versionFormat: "${major}.${minor}.${patch}.${increment}",
    ...
    test(
      ...
      async () => {
        const repo = createTestRepo(testRunner, { versionFromBranch: true });
    ...
    test(
      "Prerelease mode does not increment to 1.x.x",
      async () => {
        const repo = createTestRepo(testRunner, {
          tagPrefix: "v",
          versionFormat: "${major}.${minor}.${patch}-prerelease.${increment}",
